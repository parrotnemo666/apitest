...
import com.model.rsasign2.VerificationResponse2;
import com.service.RSA.RSASignatureService;

@Path("/rsa")
public class RSASignatureController {

    private static final Logger logger = LogManager.getLogger(RSASignatureController.class);
    private RSASignatureService rsaService = new RSASignatureService();
    ...
    public Response verify(VerificationRequest2 request) {
        ...
        try {
            ...
            VerificationResponse2 verificationResponse = new VerificationResponse2(isValid);
